# Applyze — Product Requirements Document (PRD)
...
> Applyze, Türkiye'deki iş arayanların LinkedIn, Kariyer.net, Youthall ve Anbean gibi birden fazla platformdaki iş başvurularını tek bir mobil uygulamada takip etmelerini, süreçlerini yönetmelerini ve kariyer verilerini analiz etmelerini sağlayan iOS ve Android için geliştirilmiş mobil uygulamadır.
...
| NOT-02 | Bildirim önizlemesi şirket adı içermemeli | Must | Önizleme: 'Applyze — Takip edilecek başvurular var.' |
...
| # | User Story | Kabul Kriteri | Öncelik |
|---|-----------|--------------|---------|
| 1 | Çalışırken iş arayan olarak, patron bildirimi görse bile şirketi anlamamalı. | Önizleme: 'Applyze — Takip edilecek başvurular var.' Şirket adı yok. | Must |
